          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="h-20 rounded border hover:ring-2 hover:ring-indigo-500 bg-white flex items-center justify-center text-xs text-slate-600 font-medium"
              >
                White
              </button>
              <button
                onClick={() => onSlideUpdate?.({ background: { type: 'solid', value: '#000000' } })}
                className="h-20 rounded border hover:ring-2 hover:ring-indigo-500 bg-slate-950 flex items-center justify-center text-xs text-white font-medium"
              >
                Black
              </button>
              <button
                onClick={() => onSlideUpdate?.({ background: { type: 'gradient', value: 'linear-gradient(135deg, #e0e7ff 0%, #f3e8ff 100%)' } })}
                className="h-20 rounded border hover:ring-2 hover:ring-indigo-500 flex items-center justify-center text-xs text-slate-700 font-medium"
              ...
              <button
                ...
                className="h-20 rounded border hover:ring-2 hover:ring-indigo-500 flex items-center justify-center text-xs text-white font-medium"
            ...
            <div className="space-y-2 pt-2">
              <span className="text-sm text-slate-700 font-medium">Unsplash Search</span>
      ...
      <div className="p-4 space-y-6">
        ...
        {element.type === 'text' && (
          <section className="space-y-3">
            ...
            <div className="flex gap-1">
              ...
              <Button
                variant={element.style?.fontWeight === 'bold' || element.style?.fontWeight === '700' ? 'secondary' : 'ghost'}
                size="sm" className="h-8 w-8 p-0"
                onClick={() => onUpdate(element.id, { style: { ...element.style, fontWeight: (element.style?.fontWeight === 'bold' || element.style?.fontWeight === '700') ? 'normal' : 'bold' } })}
              >
              ...
              <Button
                ...
                size="sm" className="h-8 w-8 p-0"
                onClick={() => onUpdate(element.id, { style: { ...element.style, fontStyle: element.style?.fontStyle === 'italic' ? 'normal' : 'italic' } })}
              >
              ...
              <Button
                ...
                size="sm" className="h-8 w-8 p-0"
                onClick={() => onUpdate(element.id, { style: { ...element.style, textDecoration: element.style?.textDecoration === 'underline' ? 'none' : 'underline' } })}
              >
        ...
        <section className="space-y-4 border-t pt-4">
          ...
          <div className="space-y-2">
            <span className="text-sm text-slate-700 font-medium">Fill</span>

            <div className="flex bg-slate-100 p-1 rounded-md">
              <button
                onClick={() => onUpdate(element.id, { style: { ...element.style, fillType: 'solid', backgroundImage: 'none' } })}
                className={cn("flex-1 text-xs py-1 rounded font-medium", (!element.style?.fillType || element.style?.fillType === 'solid') ? "bg-white shadow text-indigo-700" : "text-slate-700")}
              >
                Solid
              </button>
              <button
                ...
                className={cn("flex-1 text-xs py-1 rounded font-medium", element.style?.fillType === 'gradient' ? "bg-white shadow text-indigo-700" : "text-slate-700")}
              >
                Gradient
              </button>
            </div>
            ...
            {(!element.style?.fillType || element.style?.fillType === 'solid') ? (
              ...
              <div className="space-y-2">
                <div className="text-xs text-slate-700 font-medium">Gradient Presets</div>
          ...
          <div className="flex items-center justify-between pt-2">
            <span className="text-sm text-slate-700 font-medium">Opacity</span>
            <input
          ...
          <div className="flex items-center justify-between pt-2">
            <span className="text-sm text-slate-700 font-medium">Radius</span>
            <input
          ...
          {element.type === 'shape' && (
            <div className="pt-2">
              <span className="text-sm text-slate-700 font-medium">Quick Shape</span>
        ...
        {/* Animation Section */}
        <section className="space-y-4 border-t pt-4">
          <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Animation</label>
          <div className="space-y-3">
            ...
            {element.animation && element.animation.type !== 'none' && (
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <span className="text-xs text-slate-700 font-medium block mb-1">Duration (s)</span>
                  <input
                    ...
                    className="w-full p-1 bg-slate-50 border border-slate-100 rounded text-sm text-slate-900"
                  />
                </div>
                <div>
                  <span className="text-xs text-slate-700 font-medium block mb-1">Delay (s)</span>
                  <input
